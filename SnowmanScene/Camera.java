...
public class Camera {
  ...
  public enum CameraType {FRONT, SIDE};
  public enum Movement {NO_MOVEMENT, LEFT, RIGHT, UP, DOWN, FORWARD, BACK};

  private static final float DEFAULT_RADIUS = 25;
  public static final Vec3 DEFAULT_POSITION = new Vec3(0f,8.0f,19f);
  public static final Vec3 DEFAULT_POSITION_2 = new Vec3(13,13,13);
  public static final Vec3 DEFAULT_TARGET = new Vec3(0f,4.0f,0f);
  public static final Vec3 DEFAULT_TARGET2 = new Vec3(0f,3.0f,0f);
  ...
  public void setCamera(CameraType c) {
    switch (c) {
      case FRONT : setupCamera(DEFAULT_POSITION, DEFAULT_TARGET, DEFAULT_UP) ; break;
      case SIDE : setupCamera(DEFAULT_POSITION_2, DEFAULT_TARGET2, DEFAULT_UP); break;
    }
  }
